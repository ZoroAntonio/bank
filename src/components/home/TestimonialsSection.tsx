        ...
        <div className="flex flex-col md:flex-row md:items-end md:justify-between mb-14">
          <div>
            <div className="flex items-center gap-4 mb-4">
              ...
              <span className="text-[#006446] text-xs font-semibold tracking-[0.2em] uppercase">{t('home.testimonials.eyebrow')}</span>
            </div>
          ...
          <div className="flex gap-2 mt-6 md:mt-0">
            <button
              ...
              aria-label={t('home.testimonials.scrollLeft')}
            >
            ...
            <button
              ...
              className="flex h-11 w-11 items-center justify-center rounded-lg border border-[#006446]/12 bg-white text-surface-500 transition-all duration-200 hover:border-[#006446]/25 hover:text-[#006446]"
              aria-label={t('home.testimonials.scrollRight')}
            >
          ...
          {testimonials.map((item) => (
            ...
            >
              <div className="flex items-center justify-between mb-8">
                ...
                <div className="flex items-center gap-0.5" aria-label={`${item.rating} ${t('home.testimonials.starRating')}`}>
              ...
              <div className="flex items-center gap-4 pt-6 border-t border-surface-100">
                <div className="w-10 h-10 rounded-full overflow-hidden flex-shrink-0 ring-1 ring-surface-200">
                  <img src={item.avatar} alt={`${t('home.testimonials.portrait')} ${t(`home.testimonials.${item.key}.name`)}`} className="w-full h-full object-cover" />
                </div>
                <div>
